...
$(function () {
  ...
  const id1 = document.getElementById("id1"); // document.QuerySelectorAll("#id1").style.color = "blue"; 로도 가능
  ...
  $("#div3 :checked").change(function () {
    console.log(this);
    console.log($(this));
    let checkbox = $(this);
    console.log(checkbox.prop("checked")); // true of false
    console.log(checkbox.attr("checked"));
  });
  // select에 change 이벤트 핸들러 등록
  $("#national").change(function () {
    // select 태그의 option 태그 중 선택된 요소 선택
