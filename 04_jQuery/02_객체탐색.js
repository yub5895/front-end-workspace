...
let style4 = { color: "purlple", border: "2px solid" };
...
$(".wrap").children().children().children("li").css(stlye4);
...
// nextUntil(['선택자']) : 선택된 요소와 같은 레벨 요소 중 다음의 모든 요소를 선택하거나, 매개변수가 있으면 같은 레벨의 다음 요소 중 매개변수와 일치하는 요소끼지 선택
// h2 요소 이후부터 p 요소 이전에 모든 형제 요소에 테두리 : dashed
