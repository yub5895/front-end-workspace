...
var FullCalendar = (function (exports) {
  ...
  function k$1(n, l, u, i, t) {
    var r;
    for (r in u)
      "children" === r || "key" === r || r in l || g$2(n, r, null, u[r], i);
    for (r in l)
  ...
  function b$1(n, l, u) {
    "-" === l[0]
      ...
      : (n[l] =
          null == u ? "" : "number" != typeof u || a$1.test(l) ? u : u + "px");
  }
  function g$2(n, l, u, i, t) {
    ...
    n: if ("style" === l)
      ...
      (r = l !== (l = l.replace(/Capture$/, ""))),
        ...
        (n.l[l + r] = u),
        u
          ? i || n.addEventListener(l, r ? w$2 : m$1, r)
          : n.removeEventListener(l, r ? w$2 : m$1, r);
  ...
  function T$1(n) {
    ((!n.__d && (n.__d = !0) && r$1.push(n) && !$$1.__r++) ||
      o !== l$1.debounceRendering) &&
      ((o = l$1.debounceRendering) || C$1)($$1);
  }
  function $$1() {
    var n, l, u, i, t, o, f, e;
    for (
      r$1.sort(function (n, l) {
  ...
  function H$1(n, l, u, i, t, r, o, f, e, a) {
    ...
    for (u.__k = [], h = 0; h < l.length; h++)
      if (
        null !=
        (d = u.__k[h] =
          null == (d = l[h]) || "boolean" == typeof d
            ? null
            : "string" == typeof d ||
              "number" == typeof d ||
              "bigint" == typeof d
            ? p(null, d, null, null, d)
            : Array.isArray(d)
            ? p(_, { children: d }, null, null, null)
            : d.__b > 0
            ? p(d.type, d.props, d.key, d.ref ? d.ref : null, d.__v)
            : d)
      ) {
        if (
          ((d.__ = u),
          (d.__b = u.__b + 1),
          null === (y = m[h]) || (y && d.key == y.key && d.type === y.type))
        )
          m[h] = void 0;
        else
          for (v = 0; v < w; v++) {
        ...
        M(n, d, (y = y || c$1), t, r, o, f, e, a),
          (k = d.__e),
          (v = d.ref) &&
            y.ref != v &&
            (g || (g = []),
            y.ref && g.push(y.ref, null, d),
            g.push(v, d.__c || k, d)),
          null != k
            ? (null == b && (b = k),
              "function" == typeof d.type && d.__k === y.__k
                ? (d.__d = e = I$1(d, e, n))
                : (e = z$1(n, d, y, m, k, e)),
              "function" == typeof u.type && (u.__d = e))
            : e && y.__e == e && e.parentNode != n && (e = A(y));
      }
    for (u.__e = b, h = w; h--; )
      null != m[h] &&
  ...
  function M(n, u, i, t, r, o, f, e, c) {
    ...
    null != i.__h &&
      ((c = i.__h), (e = u.__e = i.__e), (u.__h = null), (o = [e])),
      (s = l$1.__b) && s(u);
    try {
      n: if ("function" == typeof $) {
        if (
          ...
          null != $.getDerivedStateFromProps &&
            ...
            h(a.__s, $.getDerivedStateFromProps(b, a.__s))),
          (y = a.props),
          (p = a.state),
          (a.__v = u),
          v)
        ...
        (a.state = a.__s),
          null != a.getChildContext && (t = h(h({}, t), a.getChildContext())),
          v ||
            null == a.getSnapshotBeforeUpdate ||
            (d = a.getSnapshotBeforeUpdate(y, p)),
          (T =
            null != s && s.type === _ && null == s.key ? s.props.children : s),
          H$1(n, Array.isArray(T) ? T : [T], u, i, t, r, o, f, e, c),
          (a.base = u.__e),
          (u.__h = null),
  ...
  function O(l, u, i, t, r, o, f, e) {
    ...
    if (null === d) y === p || (e && l.data === p) || (l.data = p);
      ...
      if (
        ...
        (a = (y = i.props || c$1).dangerouslySetInnerHTML),
      ...
      e ||
        ("value" in p &&
          ...
          (_ !== l.value ||
            ("progress" === d && !_) ||
            ("option" === d && _ !== y.value)) &&
          g$2(l, "value", _, y.value, !1),
        "checked" in p &&
          void 0 !== (_ = p.checked) &&
          _ !== l.checked &&
          g$2(l, "checked", _, y.checked, !1));
    }
    return l;
  }
  function S(n, u, i) {
  ...
  function q(n, u, i) {
    ...
    if (
      ...
      (t = n.ref) && ((t.current && t.current !== n.__e) || S(t, null, u)),
      null != (t = n.__c))
    ) {
  ...
  function F$1(l, u, i) {
    ...
    return (
      arguments.length > 2 &&
        (f.children = arguments.length > 3 ? n.call(arguments, 2) : i),
      p(l.type, f, t || l.key, r || l.ref, null)
    );
  }
  function G$1(n, l) {
    var u = {
            ...
            try {
              if (
                ...
                null != t.componentDidCatch &&
                  (t.componentDidCatch(n, i || {}), (o = t.__d)),
                o)
              )
                return (t.__E = t);
            } catch (l) {
    ...
    (l$1.__r = function (n) {
      ...
      i &&
        (u === r
          ...
          : (i.__h.forEach(k), i.__h.forEach(w$1), (i.__h = []))),
        (u = r);
    }),
      ...
      o &&
        ...
        (o.__H.__h.length &&
          ((1 !== f.push(o) && i === l$1.requestAnimationFrame) ||
            ((i = l$1.requestAnimationFrame) || j$1)(b)),
  ...
  ((w.prototype = new x$1()).isPureReactComponent = !0),
  ...
  function U(n, t, e) {
    return (
      n &&
        ...
        n.__c &&
          n.__c.__P === t &&
          (n.__e && e.insertBefore(n.__e, n.__d),
          (n.__c.__e = !0),
          (n.__c.__P = e))),
      n
    );
    ...
    (e.componentWillUnmount = function () {
      ...
      n.__v
        ? (e.l ||
          ...
          D$1(y(P, { context: e.context }, n.__v), e.l))
      ...
      for (var i in ((u = {}), e)) {
        ...
        (H && "children" === i && "noscript" === t) ||
          ...
          ("defaultValue" === i && "value" in e && null == e.value
            ...
            : null === l && (l = void 0),
          /^oninput$/i.test(i) &&
            ((i = i.toLowerCase()), u[i] && (i = "oninputCapture")),
          (u[i] = l));
      }
      "select" == t &&
        u.multiple &&
        Array.isArray(u.value) &&
        (u.value = j$2(e.children).forEach(function (n) {
        ...
        (n.props = u),
        e.class != e.className &&
          ((nn.enumerable = "className" in e),
          null != e.className && (u.class = e.className),
          Object.defineProperty(u, "className", nn));
    }
    (n.$$typeof = z), tn && tn(n);
  };
  var en = l$1.__r;
  ...
  class Theme {
    ...
    getCustomButtonIconClass(customButtonProps) {
      ...
      if (this.iconOverrideCustomButtonOption) {
        ...
        if (className) {
          return `${this.baseIconClass} ${this.applyIconOverridePrefix(
            className
          )}`;
        }
      }
    ...
    render() {
      ...
      if (customGenerator != null) {
        ...
        if (customGeneratorRes === true) {
          ...
          const isObject =
            customGeneratorRes && typeof customGeneratorRes === "object"; // non-null
      ...
      if (handleCustomRendering) {
        const generatorMeta =
          (_a = this.currentGeneratorMeta) !== null && _a !== void 0
            ? _a
            : customRenderingMetaMap === null ||
              customRenderingMetaMap === void 0
            ? void 0
  ...
  const EVENT_REFINERS = Object.assign(
    Object.assign(
  ...
  function buildEventSourceRefiners(context) {
    return Object.assign(
      Object.assign(
        Object.assign({}, EVENT_UI_REFINERS),
  ...
  function transformRawEvents(rawEvents, eventSource, context) {
    ...
    let sourceEachTransform = eventSource
  ...
  function requestJson(method, url, params) {
    ...
    if (method === "GET") {
      url +=
        (url.indexOf("?") === -1 ? "?" : "&") + new URLSearchParams(params);
    } else {
  ...
  class DayHeader extends BaseComponent {
    ...
    render() {
      let { context } = this;
      let { dates, dateProfile, datesRepDistinctDays, renderIntro } =
        this.props;
  ...
  class EventContainer extends BaseComponent {
    ...
    render() {
      ...
      return y(
        ContentContainer,
        Object.assign({}, props /* contains children */, {
          elRef: this.handleEl,
          elClasses: [
  ...
  class StandardEvent extends BaseComponent {
    render() {
      ...
      return y(
        EventContainer,
        Object.assign({}, props /* includes elRef */, {
          elTag: "a",
          elStyle: {
            borderColor: ui.borderColor,
            backgroundColor: ui.backgroundColor,
  ...
  const NowIndicatorContainer = (props) =>
  ...
  function refineRenderProps(raw) {
    ...
    let dayNumberText = raw.showDayNumber
      ? dateEnv.format(
          date,
          isMonthStart ? raw.monthStartFormat : DAY_NUM_FORMAT
        )
      : "";
    return Object.assign(
      Object.assign(
        Object.assign(
          { date: dateEnv.toDate(date), view: raw.viewApi },
          dayMeta
        ),
        { isMonthStart, dayNumberText }
      ),
  ...
  function renderInnerContent$3(props) {
    ...
    return (
      title && y("div", { className: "fc-event-title" }, props.event.title)
    );
  }
  ...
  const WeekNumberContainer = (props) =>
    y(ViewContextType.Consumer, null, (context) => {
      let { dateEnv, options } = context;
      let { date } = props;
        ...
        (InnerContent, renderProps, elAttrs) =>
          y(
            Popover,
            {
              ...
              extraAttrs:
                elAttrs /* TODO: make these time-based when not whole-day? */,
          ...
          Boolean(props.moreCnt) &&
            y(
              ContentContainer,
              {
                ...
                defaultGenerator:
                  props.defaultGenerator || renderMoreLinkInner$1,
  ...
  const RAW_EN_LOCALE = Object.assign(
    Object.assign({}, MINIMAL_RAW_EN_LOCALE),
    {
  ...
  function handleEventSources(inputs, context) {
    let unfoundSources = hashValuesToArray(
  ...
  class DateSelecting extends Interaction {
    constructor(settings) {
      ...
      let { options } = component.context;
      let dragging = (this.dragging = new FeaturefulElementDragging(
        settings.el
      ));
        ...
        if (this.isDragging) {
          ...
          if (validMutation) {
            ...
            if (receivingContext === initialContext) {
              ...
              let transformed = {};
              for (let transformer of initialContext.getCurrentData()
                .pluginHooks.eventDropTransformers) {
                Object.assign(
                  transformed,
  ...
  function getDragMetaFromEl(el) {
    ...
    let obj = str ? JSON.parse(str) : { create: false }; // if no embedded data, assume no event creation
  ...
  function renderInnerContent$2(renderProps) {
    return y(
      ...
      renderProps.timeText &&
        y("div", { className: "fc-event-time" }, renderProps.timeText),
      y(
        "div",
    ...
    render() {
      ...
      return y(
        DayCellContainer,
        {
          ...
          elAttrs: Object.assign(
            Object.assign(
              Object.assign({}, props.extraDataAttrs),
              props.showDayNumber
            ...
            !renderProps.isDisabled &&
              ...
              ? y(
                  ...
                  y(InnerContent, {
                    ...
                    elAttrs: Object.assign(
                      Object.assign({}, buildNavLinkAttrs(context, date)),
  ...
  function shouldDisplayMonthStart(date, currentRange, dateEnv) {
    ...
    return (
      !(
        currentFirstYear === currentLastYear &&
        currentFirstMonth === currentLastMonth
      ) &&
      Boolean(
  ...
  function computeFgSegPlacement(
    ...
    let hierarchy = new DayGridSegHierarchy((segEntry) => {
      ...
      let segUid =
        segs[segEntry.index].eventRange.instance.instanceId +
        ":" +
        segEntry.span.start +
        ":" +
        (segEntry.span.end - 1);
    ...
    let { singleColPlacements, multiColPlacements, leftoverMargins } =
      ...
      if (this.hiddenConsumes && touchingEntry) {
        ...
        if (!forceHidden[touchingEntryId]) {
          if (this.allowReslicing) {
            ...
            const hiddenEntry = Object.assign(
              Object.assign({}, touchingEntry),
  ...
  class TableRow extends DateComponent {
    ...
    render() {
      ...
      let businessHoursByCol = splitSegsByFirstCol(
        props.businessHourSegs,
        colCnt
      );
      let bgEventSegsByCol = splitSegsByFirstCol(props.bgEventSegs, colCnt);
      let highlightSegsByCol = splitSegsByFirstCol(
          ...
          nodes.push(
            y(
              "div",
              {
                ...
                ref: isMirror
                  ? null
                  : this.segHarnessRefs.createRef(generateSegUid(seg)),
                style: {
          ...
          nodes.push(
            y(
              ...
              fillType === "bg-event"
                ? y(
                    BgEvent,
                    Object.assign({ seg: seg }, getSegMeta(seg, todayRange))
                  )
                : renderFill(fillType)
            )
          );
    ...
    updateSizing(isExternalSizingChange) {
      ...
      if (
        ...
        if (isExternalSizingChange) {
          let frameEls = props.cells.map(
            (cell) => frameElRefs.currentMap[cell.key]
          );
          if (frameEls.length) {
            ...
            if (
              ...
              !state.framePositions.similarTo(newPositionCache)
            ) {
              this.setState({
        ...
        this.safeSetState({
          ...
          segHeights: Object.assign(
            Object.assign({}, oldSegHeights),
            newSegHeights
          ),
    ...
    querySegHeights() {
      ...
      for (let segUid in segElMap) {
        let height = Math.round(
          segElMap[segUid].getBoundingClientRect().height
        );
  ...
  class TableRows extends DateComponent {
    ...
    registerInteractiveComponent() {
      if (!this.rootEl) {
        ...
        const rootEl = firstCellEl
          ? firstCellEl.closest(".fc-daygrid-body")
          : null;
        if (rootEl) {
          this.rootEl = rootEl;
          this.context.registerInteractiveComponent(this, {
  ...
  class Table extends DateComponent {
    ...
    flushScrollReset() {
      if (
        ...
        const subjectEl = getScrollSubjectEl(
          this.elRef.current,
        ...
        if (subjectEl) {
          ...
          const scrollTop =
            subjectEl.getBoundingClientRect().top -
  ...
  function getScrollSubjectEl(containerEl, dateProfile) {
    ...
    if (dateProfile.currentRangeUnit.match(/year|month/)) {
      el = containerEl.querySelector(
        `[data-date="${formatIsoMonthStr(dateProfile.currentDate)}-01"]`
      );
      // even if view is month-based, first-of-month might be hidden...
    }
    if (!el) {
      el = containerEl.querySelector(
        `[data-date="${formatDayString(dateProfile.currentDate)}"]`
      );
  ...
  class DayTableView extends TableView {
    ...
    render() {
      ...
      let { props } = this;
      let dayTableModel = this.buildDayTableModel(
        props.dateProfile,
        dateProfileGenerator
      );
      let headerContent =
  ...
  class TableDateProfileGenerator extends DateProfileGenerator {
    ...
    buildRenderRange(currentRange, currentRangeUnit, isRangeAllDay) {
      let renderRange = super.buildRenderRange(
        currentRange,
        currentRangeUnit,
        isRangeAllDay
      );
            ...
            content: (arg) =>
              ...
              y(
                ...
                y(
                  ...
                  arg.tableColGroupNode,
                  y("tbody", null, y(TimeBodyAxis, { slatMetas: slatMetas }))
                ),
                y(
                  "div",
  ...
  class TimeCol extends BaseComponent {
    ...
    renderPositionedFgSegs(
      ...
      let { date, slatCoords, eventSelection, todayRange, nowDate } =
        this.props;
      let isMirror = isDragging || isResizing || isDateSelecting;
  ...
  class ListViewHeaderRow extends BaseComponent {
    ...
    render() {
      ...
      // will ever be falsy?
      let text = options.listDayFormat
        ? dateEnv.format(dayDate, options.listDayFormat)
        : "";
      // will ever be falsy? also, BAD NAME "alt"
      let sideText = options.listDaySideFormat
          ...
          y(
            ...
            y(
              ...
              y("span", {
                ...
                style: {
                  borderColor:
                    eventContentArg.borderColor ||
                    eventContentArg.backgroundColor,
                },
              })
            ),
            y(InnerContent, {
  ...
  function renderEventInnerContent(seg, context) {
    ...
    return y(
      "a",
      Object.assign({}, interactiveAttrs),
  ...
  class ListView extends DateComponent {
    ...
    render() {
      ...
      let eventSegs = this.eventStoreToSegs(
        props.eventStore,
        props.eventUiBases,
        dayRanges
      );
    ...
    render() {
      ...
      const tableHeight =
        props.tableWidth != null
          ? props.tableWidth / options.aspectRatio
          : null;
      ...
      return y(
        ...
        y(
          "div",
          {
            ...
            style: { marginBottom: rowHeight },
            role: "presentation",
          },
          y(
            "div",
            { className: "fc-multimonth-title", id: state.labelId },
  ...
  class MultiMonthView extends DateComponent {
    ...
    render() {
      ...
      const colCount =
        Math.min(
          clientWidth != null
            ? Math.floor(
                clientWidth / (options.multiMonthMinWidth + monthHPadding)
              )
            : 1,
          options.multiMonthMaxColumns
        ) || 1;
      const monthWidthPct = 100 / colCount + "%";
      const monthTableWidth =
        clientWidth == null ? null : clientWidth / colCount - monthHPadding;
      ...
      const monthTitleFormat = this.buildMonthFormat(
        options.multiMonthTitleFormat,
        monthDateProfiles
      );
      const rootClassNames = [
        ...
        monthTableWidth != null && monthTableWidth < 400
          ...
          : "",
        props.isHeightAuto ? "" : "fc-scroller", // for AutoScroller
      ];
      return y(
        ViewContainer,
        {
        ...
        monthDateProfiles.map((monthDateProfile, i) => {
          const monthStr = formatIsoMonthStr(
            monthDateProfile.currentRange.start
          );
          return y(
            SingleMonth,
            Object.assign({}, props, {
    ...
    flushScrollReset() {
      if (
        ...
        const scrollEl = this.scrollElRef.current;
        const monthEl = scrollEl.querySelector(
          `[data-date="${formatIsoMonthStr(currentDate)}"]`
        );
        scrollEl.scrollTop =
